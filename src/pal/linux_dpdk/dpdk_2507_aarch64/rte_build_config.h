 ...
 *
 * Adapted for aarch64 from x86_64 rte_build_config.h
 */

#pragma once

#define RTE_ARCH aarch64
...
#define RTE_COMPILE_TIME_CPUFLAGS RTE_CPUFLAG_NEON,RTE_CPUFLAG_CRC32,RTE_CPUFLAG_AES,RTE_CPUFLAG_PMULL,RTE_CPUFLAG_SHA1,RTE_CPUFLAG_SHA2
#endif
...
#define RTE_EAL_PMD_PATH "/usr/local/lib/aarch64-linux-gnu/dpdk/pmds-25.2"
